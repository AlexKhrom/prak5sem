...
var obj = {
    ...
    aiFuncOneBlock(it, mas, alpha, betta) {
        var iter = it % 2;
                ...
                for (var j = 0; j < newMas.length; j++) {
                    if (newMas[i][j] === -1) {
                        ...
                        if (this.checkMas(afterMas, i, j) === 0) {
                            ...
                            if (funcIt <= 10) { // this.mas.length * this.mas.length/2
                                res = this.aiFuncOneBlock(funcIt, afterMas,alpha,betta)
                                ...
                                if (res === 1 && iter === this.ai) {
                                    return 1
                                }
                                if (res === 0) {
                                    wasDraw = true
                                }
                                if (res < 0 && iter !== this.ai) {
                                    return res
                                }
                                masRet.push(res);
                ...
                for (j = 0; j < newMas.length; j++) {
                    if (newMas[i][j] === -1) {
                        ...
                        if (this.checkMas(afterMas, i, j) === 0) {
                            ...
                            if (funcIt <= 100) { // this.mas.length * this.mas.length/2
                                res = this.aiFuncOneBlock(funcIt, afterMas,alpha,betta)
            ...
            for (var j = 0; j < this.mas.length; j++) {
                if (this.mas[i][j] === -1) {
                    ...
                    if (this.checkMas(afterMas, i, j) === 1) {
                        ...
                        it = (this.iter + 1);
                        res = this.aiFuncOneBlock(it, afterMas,-2,2)
                        console.log("res = ", res)
                        if (res > 0) {
                            console.log("hi")
